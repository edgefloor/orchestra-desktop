// This file mostly exists because development builds need Orchestra branding instead of "electron".
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Orchestra (Dev)" : "Orchestra (Alpha)";
