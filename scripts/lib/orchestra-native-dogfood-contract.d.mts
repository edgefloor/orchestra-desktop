...
export const ORCHESTRA_NATIVE_DOGFOOD_SELECTED_ISSUE_WORKFLOW_PATH: string;
...
export const ORCHESTRA_NATIVE_DOGFOOD_CHILD_OUTPUT_NAME: string;
export const ORCHESTRA_NATIVE_DOGFOOD_CHILD_TEXT_MAX_CHARS: number;
export const ORCHESTRA_NATIVE_DOGFOOD_CHILD_OUTPUT_MAX_CHARS: number;
